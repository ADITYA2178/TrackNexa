...
export default function MiniMap() {
  return (
    <div className="relative h-44 w-full overflow-hidden rounded-2xl bg-[#D6F0FA]">
      ...
      <div className="absolute left-1/2 top-1/3 -translate-x-1/2 text-primary">
        <LineIcon type="pin" className="h-7 w-7 fill-primary" />
      </div>
    </div>
  )
}
